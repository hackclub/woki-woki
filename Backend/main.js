...
function convert(){
    ...
    addFieldToJsonObject(output, 'title', (input.name + "'s bin project"));
    ...
    shape.push(components.outline()); //Default schemma outline
